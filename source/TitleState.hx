...
class TitleState extends MusicBeatState
{
	...
	override public function create():Void
	{
		...
		if(ClientPrefs.checkForUpdates && !closedState) {
			...
			var http = new haxe.Http("https://raw.githubusercontent.com/MeguminBOT/Tri-State-Funkin-The-Funkinator/main/gitVersion.txt");

			http.onData = function (data:String)
			{
				updateVersion = data.split('\n')[0].trim();
				var curVersion:String = MainMenuState.funkinatorVersion.trim();
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 3: 
					addMoreText('about', 15);
				case 4:
					addMoreText('a certain scientist', 15);
				case 5:
					deleteCoolText();
				case 6:
				...
				case 13:
					deleteCoolText();
				case 14:
					addMoreText('Tri-State');
				case 15:
					addMoreText('Funkin');
				case 16:
					addMoreText('The Funkinator');
				case 17:
					skipIntro();
			}
		}
